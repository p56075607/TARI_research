...
def run_five_steady(IC_path):
    fig_save_ph = join(IC_path,'..')
    ...
    data_write_path = os.path.join(IC_path,'five.dm')
    ...
    # Load ASCII dat file
    dat_file_name = os.path.join(IC_path,'PostP','001_H_Dnsty_Prss.dat')
    timedata_index = []
    Line = []
